...
from . import UPSTAGE_API_KEY

llm = ChatUpstage(upstage_api_key=UPSTAGE_API_KEY, streaming=True)
...
def keyword_generator(domain: str):
    ...
    다음 형식으로 모든 키워드를 나열하십시오. 키워드의 개수는 10개 이하로 제한됩니다. 가장 중요한 키워드만 선택하여 나열해주십시오.
    1. 이름
    2. 나이
    3. 배경
    ...등.
